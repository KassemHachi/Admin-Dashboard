      ...
      <div className='col-span-1 my-4 lg:my-0  border-r-2 border-gray-200'>
        <div className='grid grid-cols-2'>
          ...
          <div className='col-span-1'>
            <h4>Total Revenue</h4>
            <h1 className='text-xl xl:text-2xl font-bold mt-1'>1,455 k</h1>
          </div>
        </div>
      </div>
      <div className='col-span-1 my-4 lg:my-0 border-r-0  lg:border-r-2 border-gray-200'>
        <div className='grid grid-cols-2'>
          <div className='col-span-1 flex justify-center items-center'>
          ...
          <div className='col-span-1'>
            <h4>Total Revenue</h4>
            <h1 className='text-xl xl:text-2xl font-bold mt-1'> 1,516</h1>
          </div>
        </div>
      </div>
      <div className='col-span-1 my-4 lg:my-0  border-r-2 border-gray-200'>
        <div className='grid grid-cols-2'>
          ...
          <div className='col-span-1'>
            ...
            <h1 className='text-xl xl:text-2xl font-bold mt-1'>  2,216</h1>
          </div>
        </div>
      </div>
      <div className='col-span-1 my-4 lg:my-0 '>
        <div className='grid grid-cols-2'>
          ...
          <div className='col-span-1'>
            ...
            <h1 className='text-xl xl:text-2xl font-bold mt-1'> $ 216k</h1>
          </div>
        </div>
      </div>
    </div>
